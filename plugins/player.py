        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"**Please Manually Add Assistant Or Connect To : @ZayNxOP 🥀** ")
    try:
    ...
    if audio:
        if round(audio.duration / 60) > DURATION_LIMIT:
            raise DurationLimitError(
                f"**Play Music Less🎶 \n🤟 Than {DURATION_LIMIT} minutes...**"
            )

        file_name = get_file_name(audio)
        title = file_name
        thumb_name = "https://telegra.ph/file/997903336de5e2d0fe551.png"
        ...
        await lel.edit("**रुको जरा... सब्र करो. 🤧...**")
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/997903336de5e2d0fe551.png", 
